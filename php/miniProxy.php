...
// retrieve the username from the Kopano WebApp EncryptionStore
// if not set redirect to the login page
require_once("../../../init.php");
require_once("../../../config.php");
require_once("../../../server/includes/core/class.encryptionstore.php");
...
// for some reason in certain circumstances the port might still be existing two times
$prefixHost = preg_replace("/\:[0-9]{2,5}$/", "", $prefixHost);
